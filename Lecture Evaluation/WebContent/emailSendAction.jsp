...
<%  
	...
	String content = "다음 링크를 눌러 인증을 진행해주세요." +
		"<a href='" + host + "emailCheckAction.jsp?code=" + new SHA256().getSHA256(to) + "'>메일 인증하기</a>";
...
%>
	...
	<section class="container mt-3" style="max-width: 560px;">
		<div class="alert alert-success mt-4" role="alert">
			이메일에 인증 메일을 발송하였습니다. 회원가입 시 입력한 이메일에서 인증을 해주세요.
		</div>
	</section>
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;">
		Copyright &copy; 2020 김동욱 All Right Reserved.
	</footer>
	<!-- 제이쿼리 자바 스크립트 추가하기 -->
